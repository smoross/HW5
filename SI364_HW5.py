...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/smorossHW5"
app.config['SQLALCHEMY_COMMIT_ON_TEARDOWN'] = True
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

# TODO: Add configuration specifications so that email can be sent from this application, like the examples you saw in the textbook and in class. 
#Make sure you've installed the correct library with pip! See textbook.
...
class User(db.Model):
    ...
    def __repr__(self):
        return "{} (ID: {})".format(self.twitter_username,self.email,self.id)
...
class TweetForm(FlaskForm):
    ...
    email = StringField("What is your email address associated with your Twitter username?", validators=[Required()])
